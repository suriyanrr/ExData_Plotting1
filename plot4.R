...
par(mfcol = c(2, 2))
plot(power_data$Date_Time, power_data$Global_active_power, type = "n",cex.lab=0.7,cex.axis=0.7, xlab = "", ylab = "Global Active Power")
lines(power_data$Date_Time, power_data$Global_active_power)

plot(power_data$Date_Time, power_data$Sub_metering_1, type = "n",cex.lab=0.7,cex.axis=0.7, xlab = "", ylab = "Energy sub metering")
...
legend("topright",bty = "n", pch = "-", lwd = 3, cex = 0.7, adj = 0.4, x.intersp = 7, y.intersp = 1, col = c("Black", "Red", "Blue"), legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"))
plot(power_data$Date_Time, power_data$Voltage, type = "n", xlab = "datetime", ylab = "Voltage",cex.lab=0.7,cex.axis=0.7)
lines(power_data$Date_Time, power_data$Voltage)

plot(power_data$Date_Time, power_data$Global_reactive_power, type = "n",cex.lab=0.7, xlab = "datetime", ylab = "Global_reactive_power",cex.axis=0.7)
